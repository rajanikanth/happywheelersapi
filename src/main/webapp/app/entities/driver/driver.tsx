            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>Status</th>
                  <th>One Time Code</th>
                  <th>One Time Expiration Time</th>
                  <th>Driver License</th>
                  <th>Phone Type</th>
                  <th>Dui Conviction</th>
              ...
              <tbody>
                {driverList.map((driver, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{driver.status}</td>
                    <td>{driver.oneTimeCode}</td>
                    <td>
                      <TextFormat type="date" value={driver.oneTimeExpirationTime} format={APP_DATE_FORMAT} />
                    </td>
                    <td>{driver.driverLicense}</td>
                    <td>{driver.phoneType}</td>
                    <td>{driver.duiConviction ? 'true' : 'false'}</td>
                    <td>{driver.felonyConviction ? 'true' : 'false'}</td>
                    <td>{driver.location ? <Link to={`location/${driver.location.id}`}>{driver.location.id}</Link> : ''}</td>
